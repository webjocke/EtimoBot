...
from game.logic.simple_dumb import simple_dumb
from game.logic.first_diamond import FirstDiamondLogic
from game.logic.webjocke_custom import Webjocke_Custom
from game.logic.crash_in_middle import CrashInMiddle
from game.logic.swarm import swarm
from game.logic.square_logic import SquareLogic
from game.logic.multibot import Multibot
...
CONTROLLERS = {
    ...
    "webjocke_custom": Webjocke_Custom,
    "RandomDiamond": RandomDiamondLogic,
    "simple_dumb": simple_dumb,
...
while True:
    ...
    #server = datetime.strptime('2018-04-30T01:51:59.031Z', '%Y-%m-%dT%H:%M:%S.%f')
    #server = time.strptime("2018-04-30T01:51:59.031Z"[:-1], "%Y-%m-%dT%H:%M:%S.%f")
    #print(str(server))
    ...
    # Try to perform move and record ping
    #start_ms = time.time()
    ...
    _time3 = time.time() - _time
    #print("Frame: " + str(_time3))
    if (_time3 < _delay):
        sleep(_delay - _time3)
    #sleep(move_delay * time_factor/10)

print("\n\r_________________________")
print("Points: "+str(score))
print("Iterations: "+str(i))
print("Drops: "+str(drops))
print("Delay: "+str(_delay))
print("Moves made :"+str(i-drops))
###############################################################################
#
# Game over!
#
...
while True:
    ...
    milli_dif = milli_sec - old_time
    
    print("=========== TIME ===========")
    print("Frame took: "+str(milli_dif)+" ms")
    print("=========== TIME ===========")

    #while(int(round(time.time()*1000)) - old_time < 250): # 200 verkar fungera
    #    pass
